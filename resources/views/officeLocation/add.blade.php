        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary mt-1">
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <form role="form" action="{{url('office-location/store')}}" method="POST">
                      @csrf
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="form-group">
                            <label>Nama Kantor</label>
                            <input type="text" name="name" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama Kantor" value="{{ old("name")}}">
                            @error('name')
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="long" class="form-control @error('long') is-invalid @enderror" value="{{ old("long")}}">
                          @error('long')
                              <div class="invalid-feedback">{{ $message }}</div>
                          @enderror
                        </div>
